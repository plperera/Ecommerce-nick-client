...
export default function SubCategoryCreator ({setRefresh, refresh}) {
    ...
    async function sendForm(){
        ...
        const body = {
            subCategoryName: form?.newSubCategory
        }
    ...
    return(
        <Container>
            <InputStyled
                onChange={handleForm}
                placeholder="Insira um nome para a SubCategoria"
                name="newSubCategory"
